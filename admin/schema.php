...
$g_upgrade[] = array('CreateTableSQL',array(db_get_table( 'config' ),"
...
$g_upgrade[2] = array('CreateTableSQL',array(db_get_table( 'bug_file' ),"
  ...
  content 		B NOTNULL " . $t_blob_default, array('mysql' => 'ENGINE=MyISAM DEFAULT CHARSET=utf8', 'pgsql' => 'WITHOUT OIDS')));
...
$g_upgrade[52] = array('AlterColumnSQL', array( db_get_table( 'bug_history' ), 'old_value C(255) ' . $t_notnull ) );
$g_upgrade[53] = array('AlterColumnSQL', array( db_get_table( 'bug_history' ), 'new_value C(255) ' . $t_notnull ) );
...
# Schema version: 60
#
$g_upgrade[60] = array('AlterColumnSQL', array( db_get_table( 'bug_history' ), 'field_name C(64) ' . $t_notnull ) );
...
$g_upgrade[65] = array('AlterColumnSQL', array( db_get_table( 'user_pref' ), 'redirect_delay 	I ' . $t_notnull . ' DEFAULT 0' ) );
...
# Schema version: 70
#
$g_upgrade[70] = array( 'AddColumnSQL', array( db_get_table( 'bug' ), 'category_id I UNSIGNED NOTNULL DEFAULT \'1\'' ) );
...
$g_upgrade[74] = array( 'AddColumnSQL', array( db_get_table( 'project' ), 'category_id I UNSIGNED NOTNULL DEFAULT \'1\'' ) );
...
$g_upgrade[78] = array( 'AddColumnSQL', array( db_get_table( 'project' ), 'inherit_global I UNSIGNED NOTNULL DEFAULT \'0\'' ) );
...
$g_upgrade[92] = array( 'RenameColumnSQL', array( db_get_table( 'bug' ), 'date_submitted_int', 'date_submitted', 'date_submitted_int		I  UNSIGNED     NOTNULL DEFAULT \'1\' ' ) );
$g_upgrade[93] = array( 'DropColumnSQL', array( db_get_table( 'bug' ), 'due_date' ) );
$g_upgrade[94] = array( 'RenameColumnSQL', array( db_get_table( 'bug' ), 'due_date_int', 'due_date', 'due_date_int		I  UNSIGNED     NOTNULL DEFAULT \'1\' ' ) );
...
$g_upgrade[109] = array( 'RenameColumnSQL', array( db_get_table( 'bug_file' ), 'date_added_int', 'date_added', 'date_added_int		I  UNSIGNED     NOTNULL DEFAULT \'1\' ' ) );
...
$g_upgrade[113] = array( 'RenameColumnSQL', array( db_get_table( 'project_file' ), 'date_added_int', 'date_added', 'date_added_int		I  UNSIGNED     NOTNULL DEFAULT \'1\' ' ) );
...
$g_upgrade[117] = array( 'RenameColumnSQL', array( db_get_table( 'bug_history' ), 'date_modified_int', 'date_modified', 'date_modified_int		I  UNSIGNED     NOTNULL DEFAULT \'1\' ' ) );
...
$g_upgrade[122] = array( 'RenameColumnSQL', array( db_get_table( 'user' ), 'date_created_int', 'date_created', 'date_created_int		I  UNSIGNED     NOTNULL DEFAULT \'1\' ' ) );
$g_upgrade[123] = array( 'DropColumnSQL', array( db_get_table( 'user' ), 'last_visit' ) );
$g_upgrade[124] = array( 'RenameColumnSQL', array( db_get_table( 'user' ), 'last_visit_int', 'last_visit', 'last_visit_int		I  UNSIGNED     NOTNULL DEFAULT \'1\' ' ) );
...
$g_upgrade[128] = array( 'RenameColumnSQL', array( db_get_table( 'email' ), 'submitted_int', 'submitted', 'submitted_int		I  UNSIGNED     NOTNULL DEFAULT \'1\' ' ) );
...
$g_upgrade[133] = array( 'RenameColumnSQL', array( db_get_table( 'tag' ), 'date_created_int', 'date_created', 'date_created_int		I  UNSIGNED     NOTNULL DEFAULT \'1\' ' ) );
$g_upgrade[134] = array( 'DropColumnSQL', array( db_get_table( 'tag' ), 'date_updated' ) );
$g_upgrade[135] = array( 'RenameColumnSQL', array( db_get_table( 'tag' ), 'date_updated_int', 'date_updated', 'date_updated_int		I  UNSIGNED     NOTNULL DEFAULT \'1\' ' ) );
...
$g_upgrade[139] = array( 'RenameColumnSQL', array( db_get_table( 'bug_tag' ), 'date_attached_int', 'date_attached', "date_attached_int		I  UNSIGNED     NOTNULL DEFAULT '1' " ) );
...
$g_upgrade[144] = array( 'RenameColumnSQL', array( db_get_table( 'tokens' ), 'timestamp_int', 'timestamp', "timestamp_int		I  UNSIGNED     NOTNULL DEFAULT '1' " ) );
$g_upgrade[145] = array( 'DropColumnSQL', array( db_get_table( 'tokens' ), 'expiry' ) );
$g_upgrade[146] = array( 'RenameColumnSQL', array( db_get_table( 'tokens' ), 'expiry_int', 'expiry', 'expiry_int		I  UNSIGNED     NOTNULL DEFAULT \'1\' ' ) );
...
$g_upgrade[151] = array( 'RenameColumnSQL', array( db_get_table( 'news' ), 'last_modified_int', 'last_modified', "last_modified_int		I  UNSIGNED     NOTNULL DEFAULT '1' " ) );
$g_upgrade[152] = array( 'DropColumnSQL', array( db_get_table( 'news' ), 'date_posted' ) );
$g_upgrade[153] = array( 'RenameColumnSQL', array( db_get_table( 'news' ), 'date_posted_int', 'date_posted', "date_posted_int		I  UNSIGNED     NOTNULL DEFAULT '1' " ) );
...
$g_upgrade[158] = array( 'RenameColumnSQL', array( db_get_table( 'bug_revision' ), 'timestamp_int', 'timestamp', 'timestamp_int		I  UNSIGNED     NOTNULL DEFAULT \'1\' ' ) );
...
$g_upgrade[164] = array( 'RenameColumnSQL', array( db_get_table( 'project_version' ), 'date_order_int', 'date_order', "date_order_int		I  UNSIGNED     NOTNULL DEFAULT '1' " ) );
...
$g_upgrade[169] = array( 'RenameColumnSQL', array( db_get_table( 'sponsorship' ), 'last_updated_int', 'last_updated', "last_updated_int		I  UNSIGNED     NOTNULL DEFAULT '1' " ) );

# ----------------------------------------------------------------------------
# Schema version: 170
#
$g_upgrade[170] = array( 'DropColumnSQL', array( db_get_table( 'sponsorship' ), 'date_submitted' ) );
$g_upgrade[171] = array( 'RenameColumnSQL', array( db_get_table( 'sponsorship' ), 'date_submitted_int', 'date_submitted', "date_submitted_int		I  UNSIGNED     NOTNULL DEFAULT '1' " ) );
